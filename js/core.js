...
// ═══════════════════════════════════════════════════════════
window.ICON_MAP = {
    // ── Pre-existing icons (root Visualization/) ──────────────
    '⌛': 'Visualization/emoticons/⌛.png',
    '⏳': 'Visualization/emoticons/⌛.png',   // ⏳ maps to existing ⌛ art
    '⏱️': 'Visualization/emoticons/⏱️.png',
    '‼️': 'Visualization/emoticons/‼️.png',
    '☁️': 'Visualization/emoticons/☁️.png',
    '☣️': 'Visualization/emoticons/☣️.png',
    '♔': 'Visualization/emoticons/♔.png', '♕': 'Visualization/emoticons/♕.png',
    '♖': 'Visualization/emoticons/♖.png', '♗': 'Visualization/emoticons/♗.png',
    '♘': 'Visualization/emoticons/♘.png', '♙': 'Visualization/emoticons/♙.png',
    '♚': 'Visualization/emoticons/♚.png', '♛': 'Visualization/emoticons/♛.png',
    '♜': 'Visualization/emoticons/♜.png', '♝': 'Visualization/emoticons/♝.png',
    ...
    '🪨': 'Visualization/emoticons/🪨.png',
    '🪵': 'Visualization/emoticons/🪵.png',
    // ── Newly added icons (were missing, now added) ────────────
    '⏸️': 'Visualization/emoticons/⏸️.png',
    '⚖️': 'Visualization/emoticons/⚖️.png',
    '⚜️': 'Visualization/emoticons/⚜️.png',
    '✉️': 'Visualization/emoticons/✉️.png',
...
window.iconImg = function (emoji, cls = 'w-6 h-6 object-contain', extra = '') {
    ...
    return `<img src="${src}" class="${cls}" ${extra} onerror="this.outerHTML='<span>${emoji}</span>'">`;
};
