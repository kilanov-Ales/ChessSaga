    ...
    ru: {
        argus: {
            ...
            story: [
                ...
                { move: "d7d6", turn: 'black', title: "Щит Тенебра", text: "Отступники укрепляют свои ряды молитвой стойкости.", icon: '<span class="icon-placeholder" data-icon="shield-alt">🛡️</span>' },
                { move: "f1c4", turn: 'white', title: "Око Пророка", text: "Верховный Мудрец направляет посох в уязвимое место.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">👁️</span>', goal: 1 },
                { move: "c8g4", turn: 'black', title: "Шепот Бездны", text: "Темный Жнец накладывает проклятие страха.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">⛓️</span>', egoal: 1 },
                ...
                { move: "h2h3", turn: 'white', title: "Слово Очищения", text: "Воздаятель направляет искру Света.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">☀️</span>' },
        ...
        standard: {
            ...
            story: [
                ...
                { move: "f1c4", turn: 'white', title: "Око Юстициария", text: "Старый воевода выискивает щель в шлеме вождя.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">👁️</span>' },
                { move: "h7h6", turn: 'black', title: "Тень Сомнения", text: "Вождь приказывает поднять щиты выше.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">☁️</span>' },
                ...
                { move: "c2c3", turn: 'white', title: "Дар Мученика", text: "Паладины бросают щиты, чтобы быть быстрее.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">🕊️</span>' },
                ...
                { move: "c4f7", turn: 'white', title: "Гнев Юстициария", text: "Клинок воеводы разрубает трон вождя!", icon: '<span class="icon-placeholder" data-icon="icon-unknown">⚔️</span>', capture: true },
                ...
                { move: "e8e7", turn: 'black', title: "Тень Агонии", text: "Вождь загнан к обрыву.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">🌫️</span>' },
        ...
        traxler: {
            ...
            story: [
                { move: "e2e4", turn: 'white', title: "Вторжение", text: "Белое Солнце выдвигает авангард.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">⚔️</span>', goal: 0 },
                { move: "e7e5", turn: 'black', title: "Ответ Луны", text: "Черный легион блокирует продвижение.", icon: '<span class="icon-placeholder" data-icon="shield-alt">🛡️</span>', egoal: 0 },
                ...
                { move: "f8c5", turn: 'black', title: "Тракслер", text: "Гамбит безумия активирован!", icon: '<span class="icon-placeholder" data-icon="icon-unknown">⚠️</span>', egoal: 1 },
                ...
                { move: "f6e4", turn: 'black', title: "Налет", text: "Черный Рыцарь в тронном зале!", icon: '<span class="icon-placeholder" data-icon="icon-unknown">☁️</span>', capture: true },
    ...
    en: {
        argus: {
            ...
            story: [
                ...
                { move: "d7d6", turn: 'black', title: "Shield of Tenebrae", text: "The Apostates fortify their ranks with a prayer of fortitude.", icon: '<span class="icon-placeholder" data-icon="shield-alt">🛡️</span>' },
                { move: "f1c4", turn: 'white', title: "Eye of the Prophet", text: "The High Sage points his staff at a vulnerable spot.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">👁️</span>', goal: 1 },
                { move: "c8g4", turn: 'black', title: "Whisper of the Void", text: "The Dark Reaper casts a curse of fear.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">⛓️</span>', egoal: 1 },
                ...
                { move: "h2h3", turn: 'white', title: "Word of Cleansing", text: "The Vindicator channels a spark of Light.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">☀️</span>' },
        ...
        standard: {
            ...
            story: [
                ...
                { move: "f1c4", turn: 'white', title: "Eye of the Justiciar", text: "The old warlord looks for a gap in the warchief's helmet.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">👁️</span>' },
                { move: "h7h6", turn: 'black', title: "Shadow of Doubt", text: "The warchief orders the shields raised higher.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">☁️</span>' },
                ...
                { move: "c2c3", turn: 'white', title: "Gift of the Martyr", text: "The paladins drop their shields to be faster.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">🕊️</span>' },
                ...
                { move: "c4f7", turn: 'white', title: "Wrath of the Justiciar", text: "The warlord's blade cleaves the warchief's throne!", icon: '<span class="icon-placeholder" data-icon="icon-unknown">⚔️</span>', capture: true },
                ...
                { move: "e8e7", turn: 'black', title: "Shadow of Agony", text: "The warchief is driven to the cliff edge.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">🌫️</span>' },
        ...
        traxler: {
            ...
            story: [
                { move: "e2e4", turn: 'white', title: "Invasion", text: "The White Sun advances its vanguard.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">⚔️</span>', goal: 0 },
                { move: "e7e5", turn: 'black', title: "Answer of the Moon", text: "The Black Legion blocks the advance.", icon: '<span class="icon-placeholder" data-icon="shield-alt">🛡️</span>', egoal: 0 },
                ...
                { move: "f8c5", turn: 'black', title: "Traxler", text: "The gambit of madness is activated!", icon: '<span class="icon-placeholder" data-icon="icon-unknown">⚠️</span>', egoal: 1 },
                ...
                { move: "f6e4", turn: 'black', title: "Raid", text: "The Black Knight is in the throne room!", icon: '<span class="icon-placeholder" data-icon="icon-unknown">☁️</span>', capture: true },
    ...
    uk: {
        argus: {
            ...
            story: [
                ...
                { move: "d7d6", turn: 'black', title: "Щит Тенебра", text: "Відступники зміцнюють свої лави молитвою стійкості.", icon: '<span class="icon-placeholder" data-icon="shield-alt">🛡️</span>' },
                { move: "f1c4", turn: 'white', title: "Око Пророка", text: "Верховний Мудрець направляє посох у вразливе місце.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">👁️</span>', goal: 1 },
                { move: "c8g4", turn: 'black', title: "Шепіт Безодні", text: "Темний Жнець накладає прокляття страху.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">⛓️</span>', egoal: 1 },
                ...
                { move: "h2h3", turn: 'white', title: "Слово Очищення", text: "Воздаятель направляє іскру Світла.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">☀️</span>' },
        ...
        standard: {
            ...
            story: [
                ...
                { move: "f1c4", turn: 'white', title: "Око Юстиціарія", text: "Старий воєвода шукає щілину в шоломі вождя.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">👁️</span>' },
                { move: "h7h6", turn: 'black', title: "Тінь Сумніву", text: "Вождь наказує підняти щити вище.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">☁️</span>' },
                ...
                { move: "c2c3", turn: 'white', title: "Дар Мученика", text: "Паладини кидають щити, щоб бути швидшими.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">🕊️</span>' },
                ...
                { move: "c4f7", turn: 'white', title: "Гнів Юстиціарія", text: "Клинок воєводи розрубує трон вождя!", icon: '<span class="icon-placeholder" data-icon="icon-unknown">⚔️</span>', capture: true },
                ...
                { move: "e8e7", turn: 'black', title: "Тінь Агонії", text: "Вождя загнано до урвища.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">🌫️</span>' },
        ...
        traxler: {
            ...
            story: [
                { move: "e2e4", turn: 'white', title: "Вторгнення", text: "Біле Сонце висуває авангард.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">⚔️</span>', goal: 0 },
                { move: "e7e5", turn: 'black', title: "Відповідь Місяця", text: "Чорний легіон блокує просування.", icon: '<span class="icon-placeholder" data-icon="shield-alt">🛡️</span>', egoal: 0 },
                ...
                { move: "f8c5", turn: 'black', title: "Тракслер", text: "Гамбіт божевілля активовано!", icon: '<span class="icon-placeholder" data-icon="icon-unknown">⚠️</span>', egoal: 1 },
                ...
                { move: "f6e4", turn: 'black', title: "Наліт", text: "Чорний Лицар у тронній залі!", icon: '<span class="icon-placeholder" data-icon="icon-unknown">☁️</span>', capture: true },
                ...
                { move: "f7h8", turn: 'white', title: "Жадность", text: "Ваш Лицар грабує скарбницю.", icon: '<span class="icon-placeholder" data-icon="icon-unknown">💎</span>', capture: true },
